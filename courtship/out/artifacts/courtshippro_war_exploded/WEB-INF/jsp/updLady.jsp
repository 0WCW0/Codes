...
<div align="center">
    ...
    <hr>
    <form action="${path}/lady/updLady" method="post">
        <input type="hidden" name="lid" value="${lady.lid}">
        姓名：<input type="text" name="lname" value="${lady.lname}"><br>
        年龄：<input type="text" name="lage" value="${lady.lage}"><br>
        身高：<input type="text" name="lheight" value="${lady.lheight}"><br>
        体重：

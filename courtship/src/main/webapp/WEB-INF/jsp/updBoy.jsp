...
<div align="center">
    ...
    <hr>
    <form action="${path}/boy/updBoy" method="post">
        <input type="hidden" name="bid" value="${boy.bid}">
        姓名：<input type="text" name="bname" value="${boy.bname}"><br>
        年龄：<input type="text" name="bage" value="${boy.bage}"><br>
        身高：<input type="text" name="bheight" value="${boy.bheight}"><br>
        体重：

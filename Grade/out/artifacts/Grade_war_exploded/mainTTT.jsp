    ...
    <div class="row">
        ...
        <div class="col-md-2 bootstrap-admin-col-left">
            ...
            <div align="center">
                ...
                <form action="searchTT.do" method="post">
                    搜索：<input type="input" id="searchTT" name="searchTT" placeholder="输入教师名" />
                    <input type="submit" id="tsubmit" name="tsubmit" value="查询" />
                </form>
                ...
                <table id="data_list" class="table table-hover table-bordered" border="1" cellspacing="0" cellpadding="0" width="500px" style="margin:0 auto">
                    ...
                    <caption>
                        个人信息
                        （<a href="TMload.do?id=${currentUser.id}"
                    ...
                    <!-- 使用c标签的遍历: 11种c标签; -->
                    <c:forEach items="${tttpmList }" var="t" varStatus="i">
            ...
            <div class="page" style="width:350px; margin:0 auto;">
                <div class="page-information">
                    ...
                    <a href="${path}listTT.do?pageNum=1" class='first'>首页</a>
                    <a href="${path}listTT.do?pageNum=${page.pageNum>1?page.pageNum-1:1}" class='pre'>上一页</a>
                    <c:forEach begin="1" end="${page.pageTitle}" var="i">
                        <a href="${path}listTT.do?pageNum=${i}" style="text-decoration: none;">${i}</a>
                    </c:forEach>
                    <a href="${path}listTT.do?pageNum=${page.pageNum<page.pageTitle?page.pageNum+1:page.pageTitle}" class='next'>下一页</a>
                    <a href="${path}listTT.do?pageNum=${page.pageTitle}" class='last'>末页</a>
                </div>
            </div>

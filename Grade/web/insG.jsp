...
<div class="container">
    ...
    <div class="row">
        ...
        <div align="center">
            ...
            <div align="center"><font style="color: red;">${msg }</font></div>
            <hr>

            <%--class="bootstrap-admin-login-form"--%>

            <form action="insG.do" method="post" class="bootstrap-admin-login-form">
                学生名:<input type="text" id="sname" name="sname" /><br>

                <%--课&nbsp;&nbsp;&nbsp;&nbsp;程:<input type="text" id="cname" name="cname" /><br>--%>
                课&nbsp;&nbsp;&nbsp;&nbsp;程:
                ...
                分&nbsp;&nbsp;&nbsp;&nbsp;数:<input type="text" id="grade" name="grade" /><br>

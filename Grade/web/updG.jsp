...
<div class="container">
    ...
    <div class="row">
        ...
        <div align="center" >
            <h3>成绩修改</h3><br>
            <a href="mainG.jsp">返回</a>
            <hr>
            <form action="updG.do" method="post" class="bootstrap-admin-login-form">
                <input type="hidden" name="gid" id="gid" value="${g.gid}"/>
                学生名：<input type="text" id="sname" name="sname" value="${g.sname}"/><br>
                课&nbsp;&nbsp;&nbsp;&nbsp;程:
                <%--<input type="text" id="cname" name="cname" value="${g.cname}"/><br>--%>
                ...
                <%--课&nbsp;&nbsp;&nbsp;&nbsp;程:<input type="text" id="cname" name="cname" value="${s.cname}" /><br>--%>
                成&nbsp;&nbsp;&nbsp;&nbsp;绩:<input type="text" id="grade" name="grade" value="${g.grade}" /><br>

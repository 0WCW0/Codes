...
<div class="container">
    ...
    <div class="row">
        ...
        <div align="center">
            <h3>学生信息录入</h3><br>
            <a href="mainS.jsp">返回</a>
            <div align="center"><font style="color: red;">${msgg }</font></div>
            <hr>

            <%--class="bootstrap-admin-login-form"--%>

            <form action="insS.do" method="post" class="bootstrap-admin-login-form">
                学生名:<input type="text" id="sname" name="sname" /><br>
                年&nbsp;&nbsp;&nbsp;&nbsp;龄:<input type="text" id="sage" name="sage" /><br>

                <%--班&nbsp;&nbsp;&nbsp;&nbsp;级:<input type="text" id="cl" name="cl" /><br>--%>

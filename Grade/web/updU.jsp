...
<div class="container">
    ...
    <div class="row">
        ...
        <div align="center" >
            <h3>用户信息修改</h3><br>
            <a href="mainU.jsp">返回</a>
            <hr>
            <form action="updU.do" method="post" class="bootstrap-admin-login-form">
                <input type="hidden" name="id" id="id" value="${u.id}"/>
                用户名：<input type="text" id="username" name="username" value="${u.username}"/><br>
                密&nbsp;&nbsp;&nbsp;&nbsp;码：<input type="text" id="password" name="password" value="${u.password}"/><br>
                类&nbsp;&nbsp;&nbsp;&nbsp;型：
                <%--<input type="text" id="type" name="type" value="${u.type}"/>--%>

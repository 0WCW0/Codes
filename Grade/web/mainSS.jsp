...
<div class="container">
    ...
    <div class="row">
        ...
        <div align="center" class="col-lg-12">
            ...
            <h3>${currentUser.getUsername() }同学</h3>
            <br>

            <form action="searchSS.do" method="post">
                搜索：<input type="input" id="searchSS" name="searchSS" placeholder="输入学生名" />
                <input type="submit" id="ssubmit" name="ssubmit" value="查询" />
            </form>
            ...
            <table id="data_list" class="table table-hover table-bordered" border="1" cellspacing="0" cellpadding="0" width="500px" style="margin:0 auto">
                ...
                <caption>
                    个人信息
                    （<a href="SMload.do?id=${currentUser.id}"
                        onclick="return confirm('您是否确认修改${currentUser.username }的信息?')">
                        修改
                     </a>）
                </caption>
                ...
                <!-- 使用c标签的遍历: 11种c标签; -->
                <c:forEach items="${sspmList }" var="s" varStatus="i">
        ...
        <div class="page" style="width:350px; margin:0 auto;">
            <div class="page-information">
                ...
                <a href="${path}listSS.do?pageNum=1" class='first'>首页</a>
                <a href="${path}listSS.do?pageNum=${page.pageNum>1?page.pageNum-1:1}" class='pre'>上一页</a>
                <c:forEach begin="1" end="${page.pageTitle}" var="i">
                    <a href="${path}listSS.do?pageNum=${i}" style="text-decoration: none;">${i}</a>
                </c:forEach>
                <a href="${path}listSS.do?pageNum=${page.pageNum<page.pageTitle?page.pageNum+1:page.pageTitle}" class='next'>下一页</a>
                <a href="${path}listSS.do?pageNum=${page.pageTitle}" class='last'>末页</a>
            </div>
        </div>
